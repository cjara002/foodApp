...
type DrawerMenuProps = {
    homeNavigate: () => void; // or replace with the correct type if it's different
  };

const DrawerMenu: React.FC<DrawerMenuProps> = ({homeNavigate}) => {
        ...
        <>
            <View style={{flex:1,backgroundColor: colors.card}}>
                ...
                <View style={{paddingHorizontal:15,paddingVertical:20,flex:1}}>
                    <Text style={{...FONTS.h6,marginBottom:5}}>Main menu</Text>
                    ...
                    <Text style={{...FONTS.h6,marginBottom:5}}>Settings</Text>
                    <TouchableOpacity
                        style={[styles.navLink]}
                    >
