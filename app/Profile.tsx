...
const renderItem: ({ item }: { item: RewardItem }) => JSX.Element = ({ item }) => {
        return(
            <View
                style={{
        ...
        <>
            ...
            >
                <View style={{
                    ...
                    <Text style={{...FONTS.h6,color:'white'}}>Profile</Text>
                </View>
                ...
                <ScrollView contentContainerStyle={{paddingBottom:100}}>
                    <View style={GlobalStyleSheet.container}>
                        ...
                        >
                            ...
                            <Text style={{...FONTS.h3,color:COLORS.primary}}>Gold member</Text>
                        </View>
                        <View
                            style={{
                                flexDirection:'row',
                        ...
                        >
                            <Text style={{...FONTS.h5,color:COLORS.title}}>Personal Information</Text>
                            <TouchableOpacity>
                        ...
                        >
                            ...
                            <View style={{flex:1}}>
                                ...
                                <Text style={{...FONTS.font,...FONTS.fontBold,fontSize:15,color:COLORS.title}}>+1 789 3456</Text>
                            </View>
                        </View>
                        <View
                            style={{
                        ...
                        >
                            ...
                            <View style={{flex:1}}>
                                ...
                                <Text style={{...FONTS.font,...FONTS.fontBold,lineHeight:22,fontSize:15,color:COLORS.title}}>Big Food, USA</Text>
                            </View>
                        </View>
